...
plt.text(1,0.27,'1',fontsize=15,color ="black")
plt.text(7,0.45,'2',fontsize=15,color ="black")
plt.text(9,0.57,'3',fontsize=15,color ="black")
plt.text(11.5,0.60,'4',fontsize=15,color ="black")
plt.text(12.3,0.55,'6',fontsize=15,color ="black")
plt.text(14.3,0.61,'5',fontsize=15,color ="black")
plt.text(16.3,0.56,'7',fontsize=15,color ="black")
